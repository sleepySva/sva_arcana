...
function ChargeFire:fireProjectile()
  ...
  if self.chargeLevel.muzzleProjectile then
    world.spawnProjectile(
        self.chargeLevel.muzzleProjectile,
        self:firePosition(),
        activeItem.ownerEntityId(),
        self:aimVector(currentAngle, 0),
        false,
        self.chargeLevel.muzzleParameters
      )
  end
