...
function MeleeCombo:createProjectiles(pType)
...
function MeleeCombo:fire()
  ...
  self:createProjectiles(self.projectileType)
  if self.comboStep == 6 then self:createProjectiles(self.projectileTypeAlt) end
  util.wait(stance.duration, function()
    if self.comboStep == 4 or self.comboStep == 5 then
