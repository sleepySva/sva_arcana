...
function ControlProjectile:createProjectiles()
  ...
  for i = 1, pCount do
    ...
    local projectileId = world.spawnProjectile(
        ...
        self:firePosition(vec2.add(aimPosition, pOffset)),
        false,
        pParams
      )
...
function ControlProjectile:firePosition(pos)
  local aimVector = vec2.norm(world.distance(activeItem.ownerAimPosition(), pos))
  return aimVector
end